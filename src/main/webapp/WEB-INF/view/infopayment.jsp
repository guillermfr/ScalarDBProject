...
<html>
<head>
    <title>Payment informations</title>
    ...
    <div class="flex-1 grow">
        ...
        <form action="infoPayment-servlet" method="post" class="pt-8">
            <div class="relative z-0 w-full mb-6 group">
                ...
                <label for="nomCarte" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Nom on the card</label>
            </div>
            <div class="relative z-0 w-full mb-6 group">
            ...
            <div class="mb-6">
                ...
                updateTotal()" />
                <label for="usePoints" class="text-sm">Use your ${sessionScope.get("user").getLoyaltyPoints()} loyalty points (- ${String.format("%.2f", Math.round(sessionScope.get("user").getLoyaltyPoints().doubleValue()))}¥)</label>
            </div>
            <div class="mb-6">
